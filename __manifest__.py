...
# Part of Softhealer Technologies.
{
    ...
    "version": "16.0.11",
    "depends": ["mail", "portal", "product", "resource", "sale_management", "purchase", "account", "hr_timesheet", "crm", "project","web"],
    "data": [
        ...
        "views/sh_helpdesk_report_portal.xml",
        ...
        "views/sh_helpdesk_ticket_merge_wizard_view.xml",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            # 'sh_all_in_one_helpdesk/static/src/js/helpdesk_ticket_dashboard.js',
